...
<%
'================================================================
' AYARLAR PANELİ  (sadece yönetici / super_yönetici)
'================================================================
%>
<div id="extra_div_main_container"<%
...
%>>
  ...
  <button class="settings_toggle" onclick="OpenPriceDiv(this)" type="button">
    <i class="fa-solid fa-sliders"></i>
    <span><%if language<>2 then Response.Write("Bayi Fiyat Listesi &mdash; Karlılık ve Görünüm Ayarları") else Response.Write("Dealer Price List &mdash; Profitability &amp; View Settings") end if%></span>
    <i class="fa fa-chevron-down settings_chevron"></i>
  </button>

  <div id="extra_div_container">
    ...
    <div class="settings_grid">
      ...
      <div class="settings_section">
        ...
        <label class="settings_radio_row">
          <input type="radio" onclick="adjust_liste(this.id)" name="adjust_liste" id="fiyat_liste" value="fiyat_liste">
...
<div id="body_div">
  ...
  <nav id="admin_menu_div">

    <% if Session("MM_UserAuthorization") <> bayi then %>
      <a href="default.asp?list=1&lng=<%=language%>" class="<%if list="1" then Response.Write("menu_active") else Response.Write("admin_menu") end if%>">
        <i class="fa-solid fa-tags"></i>
        <span><%if language<>2 then Response.Write("FİYAT LİSTESİ ÜRÜNLER") else Response.Write("PRICE LIST PRODUCTS") end if%></span>
      </a>
    <% end if %>

    <a href="default.asp?list=3&lng=<%=language%>" class="<%if list="3" then Response.Write("menu_active") else Response.Write("admin_menu") end if%>">
      <i class="fa-solid fa-handshake-angle"></i>
      <span><%if language<>2 then Response.Write("BAYİ LİSTESİ ÜRÜNLER") else Response.Write("DEALER LIST PRODUCTS") end if%></span>
    </a>

    <a href="default.asp?list=4&lng=<%=language%>" class="<%if list="4" then Response.Write("menu_active") else Response.Write("admin_menu") end if%>">
      <i class="fa-solid fa-screwdriver-wrench"></i>
      <span><%if language<>2 then Response.Write("BAYİ LİSTESİ YEDEK PARÇA") else Response.Write("DEALER LIST SPARE PARTS") end if%></span>
    </a>

    <a href="default.asp?list=5&lng=<%=language%>" class="<%if list="5" then Response.Write("menu_active") else Response.Write("admin_menu") end if%>">
      <i class="fa-solid fa-cog"></i>
      <span><%if language<>2 then Response.Write("BAYİ LİSTESİ MEKANİK") else Response.Write("DEALER LIST MECHANIC") end if%></span>
    </a>

    <a href="#" class="admin_menu sidebar_print" onclick="yazdir(); return false;">
      <i class="fa fa-print"></i>
      <span><%if language<>2 then Response.Write("YAZDIR") else Response.Write("PRINT") end if%></span>
    </a>

    <div class="print_stil_sec">
      <label class="print_stil_label">
        <i class="fa fa-palette"></i>
        <%if language<>2 then Response.Write("Yazdırma Stili") else Response.Write("Print Style") end if%>
      </label>
      <div class="print_stil_secenekler">
        <label class="print_stil_opt">
          <input type="radio" name="print_stil" value="print.css" checked onchange="printStilDegistir(this.value)"/>
          <span>
            <i class="fa fa-file-alt"></i>
            <%if language<>2 then Response.Write("Standart") else Response.Write("Standard") end if%>
          </span>
        </label>
        <label class="print_stil_opt">
          <input type="radio" name="print_stil" value="print_one_cikan.css" onchange="printStilDegistir(this.value)"/>
          <span>
            <i class="fa fa-star"></i>
            <%if language<>2 then Response.Write("Öne Çıkan") else Response.Write("Featured") end if%>
          </span>
        </label>
      </div>
    </div>
